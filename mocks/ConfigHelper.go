...
// ReadRelativeWeek provides a mock function with given fields:
func (_m *ConfigHelper) ReadRelativeWeek() (int, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ReadRelativeWeek")
	}
